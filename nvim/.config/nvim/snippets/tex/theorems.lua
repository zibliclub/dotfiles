...
return {
	...
	s(
		{ trig = "deff", snippetType = "autosnippet" },
		fmta(
			[[
        \begin{definition}
          <>
	...
	s(
		{ trig = "egg", snippetType = "autosnippet" },
		fmta(
			[[
        \begin{eg}
          <>
	...
	s(
		{ trig = "thmm", snippetType = "autosnippet" },
		fmta(
			[[
        \begin{theorem}
          <>
	...
	-- LEMMA WITHOUT NAME
	s(
		{ trig = "lemm", snippetType = "autosnippet" },
		fmta(
			[[
        \begin{lemma}
          <>
	...
	-- NOTE WITHOUT NAME
	s(
		{ trig = "ntt", snippetType = "autosnippet" },
		fmta(
			[[
        \begin{note}
          <>
	...
	s(
		{ trig = "crr", snippetType = "autosnippet" },
		fmta(
			[[
        \begin{crit}
          <>
	...
	-- TASK WITHOUT NAME
	s(
		{ trig = "tskk", snippetType = "autosnippet" },
		fmta(
			[[
        \begin{task}
          <>
	...
	-- REMARK
	s(
		{ trig = "rmm", snippetType = "autosnippet" },
		fmta(
			[[
        \begin{remark}
          <>
	...
	-- NOTATION
	s(
		{ trig = "ntn", snippetType = "autosnippet" },
		fmta(
			[[
        \begin{notation}
          <>
